...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-redux-form/node_modules/react-redux-form/lib/components/local-form-component.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-redux-form/node_modules/react-redux-form/lib/components/local-form-component.js</span></h1>
    <h2>
        
        Statements: <span class="metric">61.33% <small>(46 / 75)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">70% <small>(28 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-redux-form/node_modules/react-redux-form/lib/components/</a> &#187; local-form-component.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function LocalForm(props) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, LocalForm);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (LocalForm.__proto__ || Object.getPrototypeOf(LocalForm)).call(this, props));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.store = props.store || (0, _redux.createStore)((0, _formsReducer2.default)(_defineProperty({}, props.model, props.initialState)));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.dispatch = <span class="fstat-no" title="function not covered" >function (action) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (typeof action === 'function') {</span>
<span class="cstat-no" title="statement not covered" >        return action(_this.store.dispatch, _this.store.getState);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _this.store.dispatch(action);</span>
    };
...
<span class="cstat-no" title="statement not covered" >        this.props.getDispatch(this.dispatch);</span>
      }
    }
  }, {
    key: 'render',
    value: <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >      var allowedProps = (0, _omit2.default)(this.props, ['store', 'initialState']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(_formComponent2.default, _extends({ store: this.store }, allowedProps));</span>
    }
  }]);
&nbsp;
  return LocalForm;
...
} : <span class="branch-1 cbranch-no" title="branch not covered" >void 0;</span>
&nbsp;
